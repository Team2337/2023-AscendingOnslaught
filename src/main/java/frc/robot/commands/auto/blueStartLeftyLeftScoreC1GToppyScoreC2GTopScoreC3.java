...
public class blueStartLeftyLeftScoreC1GToppyScoreC2GTopScoreC3 extends SequentialCommandGroup{
    public blueStartLeftyLeftScoreC1GToppyScoreC2GTopScoreC3(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, Shoulder shoulder) {
        addCommands(
            new ScoreConeHigh(elbow, intake, intakespinner, shoulder),
            new DriveToPickupCone1(Constants.Auto.blueToppyTopStagingMark, autoDrive, drivetrain, elbow, heading, intake, intakespinner, shoulder),
            ...
            new ScoreConeHigh(elbow, intake, intakespinner, shoulder),
            new DriveToPickupCone2(Constants.Auto.blueLeftIntermediaryFar, Constants.Auto.blueTopStagingMark, autoDrive, drivetrain, elbow, heading, intake, intakespinner, shoulder),
