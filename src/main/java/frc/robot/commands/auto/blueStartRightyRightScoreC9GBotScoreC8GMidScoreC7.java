...
public class blueStartRightyRightScoreC9GBotScoreC8GMidScoreC7 extends SequentialCommandGroup{
    public blueStartRightyRightScoreC9GBotScoreC8GMidScoreC7(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer, Shoulder shoulder) {
        addCommands(
            ...
            new ScoreConeHigh(elbow, intake, intakespinner, robotContainer, shoulder),
            new DriveToPickupCone2(Constants.Auto.blueRightIntermediaryFar, Constants.Auto.blueMiddleStagingMark, autoDrive, drivetrain, elbow, heading, intake, intakespinner, robotContainer, shoulder),
