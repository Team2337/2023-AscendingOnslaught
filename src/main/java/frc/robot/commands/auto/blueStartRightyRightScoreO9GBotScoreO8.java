...
public class blueStartRightyRightScoreO9GBotScoreO8 extends SequentialCommandGroup{
    public blueStartRightyRightScoreO9GBotScoreO8(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer, Shoulder shoulder) {
        addCommands(
