 ...
 */
public class CartesianProfiledPointToPointLockdown extends CartesianHeadingToTargetCommand implements AutoDrivableCommand {
  ...
  public CartesianProfiledPointToPointLockdown(
  ...
  private void log() {
    if (Constants.DashboardLogging.AUTO) {
      SmartDashboard.putNumber("ProfiledP2P/Target Forward (inches)", Units.metersToInches(x));
      SmartDashboard.putNumber("ProfiledP2P/Target Strafe (inches)", Units.metersToInches(y));
