 ...
 */
public class CartesianProfiledPointToPointWithRotation extends CartesianHeadingToTargetCommand implements AutoDrivableCommand {
  ...
  private Rotation2d degree;

  public CartesianProfiledPointToPointWithRotation(
  ...
  public void initialize() {
    ...
    heading.setMaintainHeading(degree);
