 ...
 * the specified point.
 */
public class AutoCartesianVectorNoCutoff extends CartesianHeadingToTargetCommand implements AutoDrivableCommand {
  ...
  private static final double intTargetLead = 1.0; // percent, 0.0-1.0
  ...
  public AutoCartesianVectorNoCutoff(
    Translation2d target,
