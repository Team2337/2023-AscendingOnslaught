...
public class blueStartLeftyLeftScoreC1GToppyScoreC2Balance extends SequentialCommandGroup{
    public blueStartLeftyLeftScoreC1GToppyScoreC2Balance(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, Shoulder shoulder) {
        addCommands(
