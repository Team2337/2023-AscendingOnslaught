...
public class blueLeftyLeftScoreC9GToppyScoreC8GTopScoreC7 extends SequentialCommandGroup{
    public blueLeftyLeftScoreC9GToppyScoreC8GTopScoreC7(AutoDrive autoDrive, Drivetrain drivetrain, Heading heading) {
        addCommands(
            new WaitCommand(2),
