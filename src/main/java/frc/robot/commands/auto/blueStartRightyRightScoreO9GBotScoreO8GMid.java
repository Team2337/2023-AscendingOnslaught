...
public class blueStartRightyRightScoreO9GBotScoreO8GMid extends SequentialCommandGroup{
    public blueStartRightyRightScoreO9GBotScoreO8GMid(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer, Shoulder shoulder) {
        addCommands(
