...
public class BlueTeleopAutoLeftSubstation extends SequentialCommandGroup {
  AutoDrive autoDrive;
  Drivetrain drivetrain;
  Heading heading;
  double trajectoryCutoff;

  public BlueTeleopAutoLeftSubstation(AutoDrive autoDrive, Drivetrain drivetrain, Heading heading) {
    ...
    addCommands(
      new CartesianVectorProfileToPointTargetCommand(
        ...
        heading),
     new CartesianVectorProfileToPointTargetCommand(
        () -> Constants.Auto.blueLeftSubstationPickup,
        drivetrain::getTranslation,
        drivetrain::velocity,
