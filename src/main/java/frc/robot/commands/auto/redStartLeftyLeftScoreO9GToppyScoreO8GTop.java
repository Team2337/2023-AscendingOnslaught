...
public class redStartLeftyLeftScoreO9GToppyScoreO8GTop extends SequentialCommandGroup{
    public redStartLeftyLeftScoreO9GToppyScoreO8GTop(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer, Shoulder shoulder) {
        addCommands(
            new ScoreConeMid(elbow, intake, intakespinner, robotContainer , shoulder),
            new DriveToPickupCube1(
                Constants.Auto.redToppyTopStagingMark, 
                autoDrive, 
                drivetrain, 
                elbow, 
                heading, 
            ...
            new DriveToScoreMid1Cube(
                Constants.Auto.redGridLeftRobotCenter, 
            ...
            new DriveToPickupCube2(
                Constants.Auto.redLeftIntermediaryFar, 
