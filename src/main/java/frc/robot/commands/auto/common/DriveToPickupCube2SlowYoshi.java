...
public class DriveToPickupCube2SlowYoshi extends SequentialCommandGroup{
    public DriveToPickupCube2SlowYoshi(Translation2d waypoint, Translation2d target, AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer, Shoulder shoulder) {
        addCommands(
            ...
            new ParallelCommandGroup(
                ...
                new ArmAutoSetpointCubeWait(0.9, elbow, shoulder, intakespinner, Constants.Arm.ArmPosition.FLOORPICKUP2YOSHI).withTimeout(1.5),
