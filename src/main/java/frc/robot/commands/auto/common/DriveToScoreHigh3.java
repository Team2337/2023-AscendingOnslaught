...
public class DriveToScoreHigh3 extends ParallelCommandGroup{
    public DriveToScoreHigh3(Translation2d waypoint1, Translation2d waypoint2, Translation2d target, double shoulderSetpoint, double elbowSetpoint, AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, Shoulder shoulder) {
        addCommands(
