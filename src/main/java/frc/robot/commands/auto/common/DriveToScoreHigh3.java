...
public class DriveToScoreHigh3 extends SequentialCommandGroup{
    public DriveToScoreHigh3(Translation2d waypoint1, Translation2d waypoint2, Translation2d target, ArmPosition armPosition, AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake,  IntakeSpinnerLamprey intakespinner, Shoulder shoulder) {
        addCommands(
