...
public class redRightyRightScoreW9GBotScoreC8GMidScoreO8 extends SequentialCommandGroup{
    public redRightyRightScoreW9GBotScoreC8GMidScoreO8(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer, Shoulder shoulder) {
        addCommands(
