...
public class blueStartLeftyLeftScoreC1GToppyScoreC2GTopScoreO2SendIt extends SequentialCommandGroup{
    public blueStartLeftyLeftScoreC1GToppyScoreC2GTopScoreO2SendIt(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer, Shoulder shoulder) {
        addCommands(
