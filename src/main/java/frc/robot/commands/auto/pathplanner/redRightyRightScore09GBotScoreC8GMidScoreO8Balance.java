...
public class redRightyRightScore09GBotScoreC8GMidScoreO8Balance extends SequentialCommandGroup{
    public redRightyRightScore09GBotScoreC8GMidScoreO8Balance(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer, Shoulder shoulder) {
        addCommands(
            ...
            new ParallelCommandGroup(
                ...
                new ArmAutoSetpointCubeNoWait(0.7, elbow, shoulder, intakespinner, Constants.Arm.ArmPosition.FLOORPICKUPWRISTYOSHI),
            ...
            new ParallelCommandGroup(
                ...
                new ArmAutoSetpointCubeNoWait(0.7, elbow, shoulder, intakespinner, Constants.Arm.ArmPosition.SCOREHIGH)
            ),
            ...
            new ParallelCommandGroup(
                ...
                new ArmAutoSetpointCubeNoWait(0.7, elbow, shoulder, intakespinner, Constants.Arm.ArmPosition.FLOORPICKUPWRIST3YOSHI),
            ...
            new ParallelCommandGroup(
                ...
                new ArmAutoSetpointCubeNoWait(0.7, elbow, shoulder, intakespinner, Constants.Arm.ArmPosition.SCOREMID)
            ),
            new IntakeReverseCube(intake).withTimeout(0.2),
            new SequentialCommandGroup(
                ...
                new ArmAutoSetpointCubeNoWait(0.7, elbow, shoulder, intakespinner, Constants.Arm.ArmPosition.CARRY)   
            ),
