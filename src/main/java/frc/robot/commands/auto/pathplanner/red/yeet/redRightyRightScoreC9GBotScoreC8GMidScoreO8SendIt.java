...
public class redRightyRightScoreC9GBotScoreC8GMidScoreO8SendIt extends SequentialCommandGroup{
    public redRightyRightScoreC9GBotScoreC8GMidScoreO8SendIt(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer, Shoulder shoulder) {
        addCommands(
