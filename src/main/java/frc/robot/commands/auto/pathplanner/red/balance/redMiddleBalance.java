...
public class redMiddleBalance extends SequentialCommandGroup{
    public redMiddleBalance(AutoDrive autoDrive, Drivetrain drivetrain, Elbow elbow, Heading heading, Intake intake, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer, Shoulder shoulder) {
        addCommands(
            ...
            new SequentialCommandGroup(
             ...
             new FollowTrajectoryCommand(robotContainer.redMiddleBalance, true, drivetrain::getPose, autoDrive, drivetrain, heading),
