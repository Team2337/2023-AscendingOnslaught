...
public class ArmAutoSetpointWithEndingCone extends CommandBase {
    ...
    public ArmAutoSetpointWithEndingCone(ArmPosition armPosition, double tolerance, Elbow elbow, Shoulder shoulder, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer) {
        this.elbow = elbow;
