...
public class ArmAutoSetpointElbowCube extends CommandBase {
    ...
    public ArmAutoSetpointElbowCube(ArmPosition armPosition, double tolerance, Elbow elbow, Shoulder shoulder, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer) {
        this.elbow = elbow;
