...
public class ArmAutoSetpointWithEndingCube extends CommandBase {
    ...
    public ArmAutoSetpointWithEndingCube(ArmPosition armPosition, double tolerance, Elbow elbow, Shoulder shoulder, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer) {
        this.elbow = elbow;
