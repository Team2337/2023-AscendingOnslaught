...
public class ArmAutoSetpointShoulderCone extends CommandBase {
    ...
    public ArmAutoSetpointShoulderCone(ArmPosition armPosition, double tolerance, Elbow elbow, Shoulder shoulder, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer) {
        this.elbow = elbow;
