...
public class ArmSetpointWithElbowEnd extends CommandBase {
    ...
    public ArmSetpointWithElbowEnd(ArmPosition armPosition, Elbow elbow, Shoulder shoulder, IntakeSpinnerLamprey intakespinner, RobotContainer robotContainer) {
        this.elbow = elbow;
        this.tolerance = 15.0;
    ...
    public boolean isFinished() {
       return elbow.getElbowLampreyDegrees() <= armPosition.elbowCone;
    }
